# Skill reference — `create-control-manifest`

> **Category:** `engineering`  
> **Canonical playbook:** [../../.cursor/skills/create-control-manifest/SKILL.md](../../.cursor/skills/create-control-manifest/SKILL.md)
