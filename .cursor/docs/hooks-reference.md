...
Hooks are configured in `.cursor/settings.json` and fire automatically:
...
| `validate-skill-change.sh` | PostToolUse (Write/Edit) | Skill file changes | Advises running `/skill-test` after any `.cursor/skills/` file is written or edited |

Hook reference documentation: `.cursor/docs/hooks-reference/`
Hook input schema documentation: `.cursor/docs/hooks-reference/hook-input-schemas.md`
