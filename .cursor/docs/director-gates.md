...
- Gate: [GATE-ID] (see .cursor/docs/director-gates.md)
...
- Game pillars and core fantasy
- Platform and performance constraints (from `.cursor/docs/technical-preferences.md` if configured)
