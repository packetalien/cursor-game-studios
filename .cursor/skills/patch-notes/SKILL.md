...
1. Check `.cursor/docs/technical-preferences.md` for any "tone", "voice", or "style"
   fields or sections.
...
1. Glob for `docs/patch-notes-template.md` and `.cursor/docs/templates/patch-notes-template.md`.
...
### Rich procedural spine (`patch-notes`)
...
```text
You are executing the Cursor Game Studios skill `patch-notes`.
