...
3. **Engine detection**: read `.cursor/docs/technical-preferences.md` and
...
"Engine not configured in `.cursor/docs/technical-preferences.md`. Run
...
### Rich procedural spine (`smoke-check`)
...
```text
You are executing the Cursor Game Studios skill `smoke-check`.
