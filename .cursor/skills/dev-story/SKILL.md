...
Read the `Engine Specialists` section of `.cursor/docs/technical-preferences.md`
...
### Rich procedural spine (`dev-story`)
...
```text
You are executing the Cursor Game Studios skill `dev-story`.
