...
Read `.cursor/docs/workflow-catalog.yaml`. This is the authoritative list of all
...
After reading the catalog, Glob `.cursor/skills/*/SKILL.md` to get the full list
...
```text
You are executing the Cursor Game Studios skill `help`.
