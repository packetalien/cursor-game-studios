...
Spawn `creative-director` via Task using gate **CD-PLAYTEST** (`.cursor/docs/director-gates.md`).
...
### Rich procedural spine (`prototype`)
...
```text
You are executing the Cursor Game Studios skill `prototype`.
