...
**Engine**: [engine name from .cursor/docs/technical-preferences.md, or "Not configured"]
...
```text
You are executing the Cursor Game Studios skill `qa-plan`.
