...
Read `.cursor/docs/technical-preferences.md` and extract the `## Input & Platform`
...
### Rich procedural spine (`ux-design`)
...
```text
You are executing the Cursor Game Studios skill `ux-design`.
