...
After updating CLAUDE.md, create or update `.cursor/docs/technical-preferences.md` with
...
### Rich procedural spine (`setup-engine`)
...
```text
You are executing the Cursor Game Studios skill `setup-engine`.
