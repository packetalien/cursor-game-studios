...
Check:
- **Engine configured?** Read `.cursor/docs/technical-preferences.md`. If the Engine field contains `[TO BE CONFIGURED]`, the engine is not set.
...
```text
You are executing the Cursor Game Studios skill `start`.
