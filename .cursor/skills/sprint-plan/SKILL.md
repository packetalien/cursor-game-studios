...
Before finalising the sprint plan, spawn `producer` via Task using gate **PR-SPRINT** (`.cursor/docs/director-gates.md`).
...
### Rich procedural spine (`sprint-plan`)
...
```text
You are executing the Cursor Game Studios skill `sprint-plan`.
