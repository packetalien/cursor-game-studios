...
Before generating the Go/No-Go recommendation, spawn `producer` via Task using gate **PR-MILESTONE** (`.cursor/docs/director-gates.md`).
...
### Rich procedural spine (`milestone-review`)
...
```text
You are executing the Cursor Game Studios skill `milestone-review`.
