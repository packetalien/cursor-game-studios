...
Read:
- `.cursor/docs/technical-preferences.md` — engine (for engine-specific memory
...
### Rich procedural spine (`soak-test`)
...
```text
You are executing the Cursor Game Studios skill `soak-test`.
