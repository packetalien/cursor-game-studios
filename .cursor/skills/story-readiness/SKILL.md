...
See `.cursor/docs/director-gates.md` for the full check pattern and mode definitions.
...
Spawn `qa-lead` via Task using gate **QL-STORY-READY** (`.cursor/docs/director-gates.md`).
...
### Rich procedural spine (`story-readiness`)
...
```text
You are executing the Cursor Game Studios skill `story-readiness`.
