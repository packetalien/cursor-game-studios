...
in this skill — apply the check pattern from `.cursor/docs/director-gates.md`
...
After decomposing all stories (Step 4 complete) but before presenting them for write approval, spawn `qa-lead` via Task using gate **QL-STORY-READY** (`.cursor/docs/director-gates.md`).
...
### Rich procedural spine (`create-stories`)
...
```text
You are executing the Cursor Game Studios skill `create-stories`.
