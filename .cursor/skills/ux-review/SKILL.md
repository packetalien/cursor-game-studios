...
1. **Input & Platform config**: Read `.cursor/docs/technical-preferences.md` and
...
### Rich procedural spine (`ux-review`)
...
```text
You are executing the Cursor Game Studios skill `ux-review`.
