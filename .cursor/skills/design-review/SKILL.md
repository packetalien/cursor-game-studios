...
| Engine-specific patterns or APIs | Primary engine specialist (from `.cursor/docs/technical-preferences.md`) |
...
### Rich procedural spine (`design-review`)
...
```text
You are executing the Cursor Game Studios skill `design-review`.
