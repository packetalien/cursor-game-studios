...
- Read `.cursor/docs/technical-preferences.md` to identify the engine and version
...
Use the template structure from `.cursor/docs/templates/game-design-document.md`:
...
Before finalizing the GDD, spawn `creative-director` via Task using gate **CD-GDD-ALIGN** (`.cursor/docs/director-gates.md`).
...
### Rich procedural spine (`design-system`)
...
```text
You are executing the Cursor Game Studios skill `design-system`.
