...
Read `.cursor/docs/coding-standards.md` for severity/priority definitions if they
...
### Rich procedural spine (`bug-triage`)
...
```text
You are executing the Cursor Game Studios skill `bug-triage`.
