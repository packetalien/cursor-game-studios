...
- Read `.cursor/docs/technical-preferences.md`
...
Spawn `technical-director` via Task using gate **TD-MANIFEST** (`.cursor/docs/director-gates.md`).
...
### Rich procedural spine (`create-control-manifest`)
...
```text
You are executing the Cursor Game Studios skill `create-control-manifest`.
