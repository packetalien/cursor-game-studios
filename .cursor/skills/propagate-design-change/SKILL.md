...
Spawn `technical-director` via Task using gate **TD-CHANGE-IMPACT** (`.cursor/docs/director-gates.md`).
...
### Rich procedural spine (`propagate-design-change`)
...
```text
You are executing the Cursor Game Studios skill `propagate-design-change`.
