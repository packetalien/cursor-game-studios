...
- **engine UI specialist** — Validates UI implementation patterns against engine-specific best practices (read from `.cursor/docs/technical-preferences.md` Engine Specialists → UI Specialist)
...
```text
You are executing the Cursor Game Studios skill `team-ui`.
