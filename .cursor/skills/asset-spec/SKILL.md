...
- **Technical preferences**: Read `.cursor/docs/technical-preferences.md` — extract performance budgets and naming conventions.
...
### Rich procedural spine (`asset-spec`)
...
```text
You are executing the Cursor Game Studios skill `asset-spec`.
