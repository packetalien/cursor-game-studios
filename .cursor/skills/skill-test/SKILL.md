...
Validates `.cursor/skills/*/SKILL.md` files for structural compliance and
...
- `static all` → run 7 structural checks on all skills (Glob `.cursor/skills/*/SKILL.md`)
...
Glob `.cursor/skills/*/SKILL.md` to get the complete list of skills.
...
### Rich procedural spine (`skill-test`)
...
```text
You are executing the Cursor Game Studios skill `skill-test`.
