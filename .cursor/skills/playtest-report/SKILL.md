...
After categorising findings, spawn `creative-director` via Task using gate **CD-PLAYTEST** (`.cursor/docs/director-gates.md`).
...
### Rich procedural spine (`playtest-report`)
...
```text
You are executing the Cursor Game Studios skill `playtest-report`.
