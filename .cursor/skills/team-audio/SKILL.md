...
Spawn the **primary engine specialist** in parallel (from `.cursor/docs/technical-preferences.md` Engine Specialists) to validate the integration approach:
...
### Rich procedural spine (`team-audio`)
...
```text
You are executing the Cursor Game Studios skill `team-audio`.
