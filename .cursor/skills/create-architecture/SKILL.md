...
3. `.cursor/docs/technical-preferences.md` — naming conventions, performance budgets,
...
Apply gate **TD-ARCHITECTURE** (`.cursor/docs/director-gates.md`) as a self-review. Check all four criteria from that gate definition against the completed document.
...
**Step 2 — Spawn `lead-programmer` via Task using gate LP-FEASIBILITY (`.cursor/docs/director-gates.md`):**
...
### Rich procedural spine (`create-architecture`)
...
```text
You are executing the Cursor Game Studios skill `create-architecture`.
