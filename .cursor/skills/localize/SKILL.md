...
Read `.cursor/docs/technical-preferences.md` to determine the engine. Then check:
...
### Rich procedural spine (`localize`)
...
```text
You are executing the Cursor Game Studios skill `localize`.
