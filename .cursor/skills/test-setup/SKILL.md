...
1. **Read engine config**:
   - Read `.cursor/docs/technical-preferences.md` and extract the `Engine:` value.
...
### Rich procedural spine (`test-setup`)
...
```text
You are executing the Cursor Game Studios skill `test-setup`.
