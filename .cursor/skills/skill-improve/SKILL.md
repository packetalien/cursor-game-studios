...
Verify `.cursor/skills/[name]/SKILL.md` exists. If not, stop with:
...
Read the full skill file at `.cursor/skills/[name]/SKILL.md`.
...
Ask: "May I write this improved version to `.cursor/skills/[name]/SKILL.md`?"
...
Write the improved skill to `.cursor/skills/[name]/SKILL.md`.
...
Ask: "May I revert `.cursor/skills/[name]/SKILL.md` using git checkout?"
If yes: run `git checkout -- .cursor/skills/[name]/SKILL.md`
...
### Rich procedural spine (`skill-improve`)
...
```text
You are executing the Cursor Game Studios skill `skill-improve`.
