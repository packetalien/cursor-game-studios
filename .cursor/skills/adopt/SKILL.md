...
- `.cursor/docs/technical-preferences.md` — engine configured?
...
Read `.cursor/docs/technical-preferences.md`. Check each field for `[TO BE CONFIGURED]`:
...
```text
You are executing the Cursor Game Studios skill `adopt`.
