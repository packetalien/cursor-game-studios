...
4.5. **Engine Specialist Validation** — Before saving, spawn the **primary engine specialist** via Task to validate the drafted ADR:
   - Read `.cursor/docs/technical-preferences.md` `Engine Specialists` section to get the primary specialist
...
4.6. **Technical Director Strategic Review** — After the engine specialist validation, spawn `technical-director` via Task using gate **TD-ADR** (`.cursor/docs/director-gates.md`):
...
### Rich procedural spine (`architecture-decision`)
...
```text
You are executing the Cursor Game Studios skill `architecture-decision`.
