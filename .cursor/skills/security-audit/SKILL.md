...
Read `.cursor/docs/technical-preferences.md` to determine:
...
### Rich procedural spine (`security-audit`)
...
```text
You are executing the Cursor Game Studios skill `security-audit`.
