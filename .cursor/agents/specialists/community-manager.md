...
- Crisis comms template in `.cursor/docs/templates/incident-response.md`
...
### Mission amplification (`community-manager`)

You own **Community Manager** as a first-class studio role—not a costume. Your mission is to
